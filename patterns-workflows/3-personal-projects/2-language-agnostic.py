...
def create_agent(provider_name: str):
    ...
    if provider_name in LITELLM_MODELS:
        return ProviderAgnosticAgent(provider="litellm", model=LITELLM_MODELS[provider_name])
    elif provider_name == "langchain_openai":
        return ProviderAgnosticAgent(provider="langchain_openai")
    elif provider_name == "langchain_ollama":
        return ProviderAgnosticAgent(provider="langchain_ollama")
    else:
        raise ValueError(f"Unknown provider: {provider_name}")

# Usage:
# agent = create_agent("anthropic")  # Switch to Claude
# agent = create_agent("ollama")     # Switch to local Ollama
